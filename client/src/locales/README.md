# AI.web3.club Localization Guide

This guide explains how to add new languages to AI.web3.club's localization system.

## Adding a New Language

To add a new language to AI.web3.club, follow these steps:

### 1. Add the Language to Locize Project

- Navigate to the [AI.web3.club locize project](https://www.locize.app/cat/62uyy7c9), 
...
1. The empty translation file will be populated through AI.web3.club's automated translation platform
